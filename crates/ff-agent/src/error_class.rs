...
///
/// Direct semantic sites should use [`prefix`] with a specific constant. This
/// fallback guarantees that opaque errors from subprocesses and anyhow chains
/// still obey the persisted-message contract.
