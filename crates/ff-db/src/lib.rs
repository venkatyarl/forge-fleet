...
pub use queries::{
    DeferredTaskRow, FleetModelRow, FleetNodeRow, FleetSecretRow, ModelCatalogRow,
    ModelDeploymentRow, ModelJobRow, ModelLibraryRow, pg_append_routing_log,
    pg_cancel_deferred, pg_claim_deferred, pg_create_job, pg_delete_deployment,
    pg_delete_library, pg_delete_secret, pg_enqueue_deferred, pg_finish_deferred,
    pg_get_catalog, pg_get_deferred, pg_get_node, pg_get_secret, pg_get_setting,
    pg_get_task_lineage, pg_insert_disk_usage, pg_latest_disk_usage, pg_list_catalog,
    pg_list_deferred, pg_list_deployments, pg_list_jobs, pg_list_library, pg_list_models,
    pg_list_models_for_node, pg_list_nodes, pg_list_secrets, pg_retry_deferred,
    pg_scheduler_pass, pg_search_catalog, pg_set_secret, pg_set_setting, pg_update_job_progress,
    pg_upsert_catalog, pg_upsert_deployment, pg_upsert_library, pg_upsert_model, pg_upsert_node,
