...
static PG_MIGRATIONS: &[PgMigration] = &[
    ...
    // 259-268 are reserved by in-flight branches; gaps are fine, collisions
    // are not.
    PgMigration {
        version: 269,
        name: "workstream_thread_concurrency",
        sql: schema::SCHEMA_V269_WORKSTREAM_THREAD_CONCURRENCY,
    },
];
