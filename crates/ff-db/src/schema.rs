...
/// V261 — Meta-memory for retrieval quality and repeated known-unknowns.
pub const SCHEMA_V261_MEMORY_RETRIEVAL_LOG: &str = r#"
...
CREATE INDEX IF NOT EXISTS idx_memory_retrieval_log_misses
    ON memory_retrieval_log (ts DESC, caller)
    WHERE was_miss;
"#;
