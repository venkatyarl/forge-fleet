...
impl HeartbeatPublisher {
            ...
            loop {
                tokio::select! {
                    _ = tokio::time::sleep(self.interval) => {
                        let metrics = self.collect_local_metrics();
    ...
    fn collect_local_metrics(&self) -> NodeMetrics {
        ...
        NodeMetrics {
            ...
            disk_used_gb,
            disk_total_gb,
            loaded_models: vec![],  // populated by orchestrator layer
            active_tasks: 0,        // populated by orchestrator layer
            queue_depth: 0,         // populated by orchestrator layer
            tokens_per_sec: 0.0,    // populated by orchestrator layer
            temperature_c: None,    // platform-specific, optional
            uptime_secs,
        }
    }
}
