...
function QuickAction({ label, icon: Icon, to }: { label: string; icon: ElementType; to: string }) {
  return (
    <Link
      href={to}
        ...
        <div className="space-y-6 lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <Link href="/fleet" className="text-xs text-primary hover:text-primary-muted">
                View all
              </Link>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <Link href="/my-tasks" className="text-xs text-primary hover:text-primary-muted">
                View all
              </Link>
            </CardHeader>
            {workItems.length === 0 ? (
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <Link href="/brain" className="text-xs text-primary hover:text-primary-muted">
                View all
              </Link>
            </CardHeader>
            {chats.length === 0 ? (
          ...
          <Card>
            <CardHeader>
              ...
              <Link href="/audit" className="text-xs text-primary hover:text-primary-muted">
                View all
              </Link>
            </CardHeader>
            {activity.length === 0 ? (
