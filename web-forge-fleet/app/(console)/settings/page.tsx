...
import ModelHubPage from '@/app/(console)/model-hub/page'
import ToolInventoryPage from '@/app/(console)/tools/page'
...
export default function SettingsPage() {
  const [activeTab, setActiveTab] = useState<SettingsTab>(() => {
    // Guarded for the static-export prerender, where `window` is undefined.
