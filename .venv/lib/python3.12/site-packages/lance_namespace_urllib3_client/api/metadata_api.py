...
class MetadataApi:
    ...
    def batch_create_table_versions(
        ...
        :param batch_create_table_versions_request: (required)
        :type batch_create_table_versions_request: BatchCreateTableVersionsRequest
        :param delimiter: An optional delimiter of the `string identifier`, following the Lance Namespace spec. When not specified, the `$` delimiter must be used. 
        :type delimiter: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._batch_create_table_versions_serialize(
            batch_create_table_versions_request=batch_create_table_versions_request,
            delimiter=delimiter,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BatchCreateTableVersionsResponse",
            '400': "ErrorResponse",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '404': "ErrorResponse",
    ...
    @validate_call
    def batch_create_table_versions_with_http_info(
        self,
        batch_create_table_versions_request: BatchCreateTableVersionsRequest,
        delimiter: Annotated[Optional[StrictStr], Field(description="An optional delimiter of the `string identifier`, following the Lance Namespace spec. When not specified, the `$` delimiter must be used. ")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BatchCreateTableVersionsResponse]:
        """Atomically create versions for multiple tables
    ...
    @validate_call
    def batch_create_table_versions_without_preload_content(
        self,
        batch_create_table_versions_request: BatchCreateTableVersionsRequest,
        delimiter: Annotated[Optional[StrictStr], Field(description="An optional delimiter of the `string identifier`, following the Lance Namespace spec. When not specified, the `$` delimiter must be used. ")] = None,
        _request_timeout: Union[
    ...
    def _batch_create_table_versions_serialize(
        self,
        batch_create_table_versions_request,
        delimiter,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if batch_create_table_versions_request is not None:
            _body_params = batch_create_table_versions_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/table/version/batch-create',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
